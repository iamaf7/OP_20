...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u256.fromString('1000000000000000000000000000'); // 1,000,000 tokens with 18 decimals.
        const decimals: u8 = 18; // 18.
        const name: string = 'Test'; // AF7.
        const symbol: string = 'TEST'; // AF7.
